...
class SettingsScreen extends ConsumerWidget {
              ...
              SettingsSection(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    subtitle: const Text('Material You — theme from your device wallpaper instead of app colors'),
              ...
              SettingsSection(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        SegmentedButton<SpeechEngine>(
                          segments: const [
                            ButtonSegment(value: SpeechEngine.onDevice, label: Text('On-device')),
                            ButtonSegment(value: SpeechEngine.googleCloud, label: Text('Google Cloud')),
                          ],
                          selected: {settings.speechEngine},
                          onSelectionChanged: (value) => controller.setSpeechEngine(value.first),
                        ),
                  ...
                  if (settings.speechEngine == SpeechEngine.googleCloud) ...[
                    const Divider(height: 1),
                    GoogleCloudSpeechSettings(apiKey: settings.googleCloudApiKey),
                  ],
                ],
              ),
              SettingsSection(
              ...
              SettingsSection(
                ...
                children: [
                  ListTile(
                    ...
                    subtitle: const Text('Save history, folders, tasks & settings to a file'),
  ...
  Future<void> _exportBackup(BuildContext context, WidgetRef ref) async {
    try {
      ...
      if (context.mounted) AppSnackbar.show(context, 'Could not create the backup.', isError: true);
    }
  }
  ...
  Future<void> _restoreBackup(BuildContext context, WidgetRef ref) async {
    ...
    try {
      ...
      if (context.mounted) {
        AppSnackbar.show(context, 'That file could not be restored.', isError: true);
      }
    }
  }
